...
class CrawlClass(object):
    ...
    def refine(self):
        ...
        for row in rows:
            ...
            pattern_supvsn = r'\<em\>주 관\<\/em\>\<span\>(.*)\<\/span\>\<\/li\>'
            pattern_addt_dtl = r'\<em\>장 소\<\/em\>\<span\>(.*)\<\/span\>\<\/li\>'
            pattern_date = r'\<em\>기 간\<\/em\>\<span\>(.*)\<\/span\>\<\/li\>'
            pattern_time = r'\<em\>시 간\<\/em\>\<span\>(.*)\<\/span\>\<\/li\>'
            pattern_cost = r'\<li\>\<img alt\=\"입장료\" src\=\"\/kor' \
                           r'\/images\/program\/item\_sch\_04.gif\"\/\> \<span\>(.*)\<\/span\>'
