...
def naver_web_crawling(search_blog_keyword, display_count, sort_type):
    search_result_web_page_count = get_web_search_result_pagination_count(search_blog_keyword, display_count)
    get_blog_post(search_blog_keyword, display_count, search_result_web_page_count, sort_type)


def get_web_search_result_pagination_count(search_blog_keyword, display_count):
...
def get_blog_post(search_blog_keyword, display_count, search_result_blog_page_count, sort_type):
    ...
    #with open("/home/all_api_crawler/{y}/{m}/web_{date}_{key}.csv".format(
    with open(r"originalDatas\all_api_crawler\{y}\{m}\{date}_web_{key}.csv".format(
        ...
        for i in range(1, search_result_blog_page_count + 1, 100):
            url = "https://openapi.naver.com/v1/search/webkr?query=" + encode_search_blog_keyword + \
