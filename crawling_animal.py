...
def run():
    ...
    res = []
    page = {
        'protection': 293, 'agent': 356, 'hospital': 482, 'production': 178,
        'importation': 8, 'sales': 420, 'exhibition': 61,
        'management': 408, 'transportation': 52, 'beauty': 672, 'funeral': 5
    }
    url = {
        'protection': 'https://www.animal.go.kr/front/awtis/institution/institutionList.do?menuNo=1000000059',
...
def save():
    ...
    for row in rs:
        ...
        k = '크롤링'
        l = 'http'
        m = 'https://www.animal.go.kr/front/awtis/shop/salesList.do?sWrkCd=A&menuNo=6000000009'
        n = 'www'
        o = '1'
        p = 'c'
        q = '이준재'
    ...
    wb.save('C:/workSpace/flask_crawling/originalDatas/A1111_반려동물_판매업소.xlsx')
