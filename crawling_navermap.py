...
class CrawlClass(object):
    ...
    def crawl(self, key):
        ...
        '''self.driver.find_element_by_xpath(
            '/html/body/app/layout/div[2]/div[2]/div[1]/shrinkable-layout/search-layout/search-box/div/div/div/input'
        ).send_keys(key)
        self.driver.find_element_by_xpath(
        ...
        length = self.driver.find_elements_by_xpath(
            '/html/body/app/layout/div[2]/div[2]/div[1]/shrinkable-layout/search-layout/search-list/search-list-contents/perfect-scrollbar/div/div[1]/div/div/div/search-item-place/div')
